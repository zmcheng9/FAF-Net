#!/bin/bash
# evaluate a model to segment abdominal CT
GPUID1=0
...
do
  ...
  do
    ...
    RELOAD_MODEL_PATH="./data/codes/exps_on_SABS/FAFNet_train_SABS_cv${EVAL_FOLD}/1/snapshots/xxx.pth"
    python3 evaluate.py with \
    mode="test" \
    dataset=$DATASET \
    num_workers=$NWORKER \
    n_steps=$NSTEP \
